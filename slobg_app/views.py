...
def generate_certificate(request):
   ...
   if(request.user.is_staff) and person_id != '':
      ...
      seal_url = request.build_absolute_uri(staticfiles_storage.url('slobg_app/img/seal.png'))
      seal = ImageReader(seal_url)
      p.drawImage(seal, 270, 100, width=100, height=100, mask='auto')
      logo_url = request.build_absolute_uri(staticfiles_storage.url('slobg_app/img/slobg_logo.png'))
